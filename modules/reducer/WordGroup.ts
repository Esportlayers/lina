import {
  ActionDispatcher,
  CALL_API,
} from "../middleware/NetworkMiddlewareTypes";
import {
  CREATE_WORD_GROUP_FAILURE,
  CREATE_WORD_GROUP_REQUEST,
  CREATE_WORD_GROUP_SUCCESS,
  DELETE_WORD_GROUP_FAILURE,
  DELETE_WORD_GROUP_REQUEST,
  DELETE_WORD_GROUP_SUCCESS,
  LOAD_WORD_GROUPS_FAILURE,
  LOAD_WORD_GROUPS_REQUEST,
  LOAD_WORD_GROUPS_SUCCESS,
  UPDATE_WORD_GROUP_FAILURE,
  UPDATE_WORD_GROUP_REQUEST,
  UPDATE_WORD_GROUP_SUCCESS,
} from "./Actions";
...
addReducer<DeleteWordGroup>(
  DELETE_WORD_GROUP_SUCCESS,
  (
    state,
    {
      options: {
        urlParams: { wordGroupId },
      },
    }
  ) => {
...
export function updateWordGroup(
  wordGroupId: number,
  data: Partial<WordGroup>
...
export function deleteWordGroup(
  wordGroupId: number
): ActionDispatcher<Promise<void>> {
  return async (dispatch) => {
    await dispatch<Promise<Response | NetworkError>>({
